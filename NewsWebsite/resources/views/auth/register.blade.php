                ...
                <div class="card-body" style="margin-left: 35px">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-8">
                                <input placeholder="Nhập địa chỉ mail" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}"  autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" style="margin-left: 91px;">
                                <input placeholder="Nhập họ" id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}"  autocomplete="first_name" autofocus>
                        ...
                        <div class="form-group row" style="margin-left: 8px ;">
                            ...
                            <div class="col-md-8">
                                <input placeholder="Nhập tên" id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}"  autocomplete="last_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input placeholder="Nhập mật khẩu" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password"  autocomplete="new-password">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input placeholder="Mật khẩu confirm " id="password-confirm" type="password" class="form-control" name="password_confirmation"  autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea name="address" id="address"  cols="51" placeholder=" Nhập địa chỉ...."></textarea>
                            </div>
