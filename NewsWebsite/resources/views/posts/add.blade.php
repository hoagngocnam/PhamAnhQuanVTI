        ...
        <div class="card-body" style="margin-left: 350px ;">
            <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <input id="post_time" type="date" class="form-control" name="post_time">
                    </div>
                </div>
                @error('post_time')
                <span class="invalid-feedback" style="display:block;margin-left :210px " role="alert">
                    ...
                    <div class="col-md-4">
                        <div class="block-text mt-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" value="0" {{ old('hot_flag') == 0 ? '' : '' }}
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" value="1" {{ old('hot_flag') == 1 ? '' : '' }}
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-md-4">
                        <input type="file" name="photo" id="photo" onchange="ImagesFileAsURL()" />
