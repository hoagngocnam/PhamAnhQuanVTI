...
<div id="content" class="container-fluid mt-4">
    <div class="card">
                        ...
                        <div class="">
                            <div class="block-text mt-2 ml-5 mb-2 ">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="radio-b1" name="sex" value="0"
                                        {{ $sex === 0 ? 'checked' : '' }}>
                                    <label class="custom-control-label font-weight-normal" for="radio-b1">Nam</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="radio-b2" name="sex" value="1"
                                        {{ $sex === 1 ? 'checked' : '' }}>
                                    <label class="custom-control-label font-weight-normal" for="radio-b2">Nữ</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="radio-b3" name="sex" value="2"
                                        {{ $sex === 2 ? 'checked' : '' }}>
        ...
        <div class="card-body">
            ...
            @endif
            <table class="table table-striped table-checkall mt-2">
                <thead>
                    <tr>
                        <th scope="col">STT</th>
